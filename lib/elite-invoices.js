...
function invoiceDashboardStats(invoices, options = {}) {
  ...
  const cursorDate = options.cursor ? new Date(options.cursor) : new Date();
  const safeCursor = Number.isNaN(cursorDate.getTime()) ? new Date() : cursorDate;

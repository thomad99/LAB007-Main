...
function setupPortalLogoDataUri() {
  const logoPath = path.join(__dirname, '..', 'public', 'smarthours-assets', 'smarthours-setup-logo.jpg');
  try {
...
.brand{display:block;width:100%;max-width:320px;height:auto;margin:0 auto 14px;background:#fff;border-radius:14px;padding:10px 12px;box-sizing:border-box}
.account{color:#e2e8f0;margin:0 0 10px;line-height:1.45;text-align:center;font-size:.95rem}
.sub{color:#94a3b8;margin:0 0 20px;line-height:1.4;text-align:center}

...
function createCloneScript() {
    ...
    // Get folder and move options
    const destinationFolder = document.getElementById('cloneDestinationFolder').value.trim();
    const moveSourceAfterClone = document.getElementById('moveSourceAfterClone').checked;
    const sourceMoveFolder = document.getElementById('sourceMoveFolder').value.trim();
    ...
    const script = generateCloneScript(selectedImages, destinationFolder, moveSourceAfterClone, sourceMoveFolder);
...
function generateCloneScript(selectedImages, destinationFolder, moveSourceAfterClone, sourceMoveFolder) {
    const scriptLines = [

...
function generateUserReportScript() {
    ...
    lines.push('        Write-Host ("  audit-events fetch: endpoint={0} page={1} (elapsed {2}s, collected {3})..." -f $epPath, $page, [int]((Get-Date) - $start).TotalSeconds, $all.Count) -ForegroundColor DarkCyan');
    ...
    lines.push('        Write-Host ("    page {0} (elapsed {1}s)..." -f $page, [int]((Get-Date) - $sessStart).TotalSeconds) -ForegroundColor DarkGray');
